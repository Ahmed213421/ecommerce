...
<h2 class="mb-2 page-title">{{ trans('dashboard.all') }} {{ trans('general.contact') }}</h2>
                        ...
                        <table class="table datatables dataTable no-footer w-100" id="dataTable-1"
                            ...
                            <tbody>
                                ...
                                <tr role="row" class="even">
                                        ...
                                        <td>{{ $user->phone }}</td>
                                        <td>{{ $user->subject }}</td>
                                        <td>{{ Str::limit($user->message,10) }}</td>
                                ...
                                @include('dashboard.contactors.view')
                                @include('dashboard.contactors.delete')
                                @endforeach
                            </tbody>
                    </div>
                </div>
