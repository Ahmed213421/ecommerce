<aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
    ...
    <nav class="vertnav navbar navbar-light">
      ...
      <ul class="navbar-nav flex-fill w-100 mb-2">
        <li class="nav-item dropdown">
          <a href="#dashboard" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
            ...
            <span class="ml-3 item-text">{{ trans('dashboard.dashboard') }}</span><span class="sr-only">(current)</span>
          </a>
      ...
      <ul class="navbar-nav flex-fill w-100 mb-2">
        ...
        {{-- <li class="nav-item dropdown {{Route::is('admin.slider.*') ? 'active' : ''}}">
          <a href="#ui-elements1" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link {{Route::is('admin.category.*') ? 'activelink' : ''}}">
            <i class="fe fe-box fe-16"></i>
            <span class="ml-3 item-text">{{ trans('dashboard.slider') }}</span>
          </a>
          <ul class="collapse list-unstyled pl-4 w-100 {{Route::is('admin.slider.*') ? 'show' : ''}}" id="ui-elements1">
            <li class="nav-item">
              <a class="nav-link pl-3" href="{{route('admin.category.index')}}"><span class="ml-1 item-text">{{ trans('dashboard.all_cat') }}</span>
              </a>
            </li>
