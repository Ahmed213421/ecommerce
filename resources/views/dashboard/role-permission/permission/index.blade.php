...
@section('breadcumbactive')
    <li class="breadcrumb-item active" aria-current="page">{{ trans('spatie.perrmisssions') }}</li>
@endsection
                            ...
                            <h4>{{ trans('spatie.perrmisssions') }}
                                @if (auth('admin')->check() && auth('admin')->user()->can('create-permission'))
                                    <a href="{{ url('dashboard/permissions/create') }}"
                                        class="btn btn-primary float-end">{{ trans('dashboard.add_permission') }}</a>
                                @endif
                            </h4>
                        </div>
                        <div class="card-body">
